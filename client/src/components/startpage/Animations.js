...
import { createCube } from './ThreeJSCube';
import {
    CubeTextureLoader,
    BoxBufferGeometry,
    MathUtils,
...
class Animations extends Component {
    ...
    render() {
     ...
     "Show your creativity and create art directly on the blockchain",
        "The last minted artwork will be displayed right in front of the landingpage", 
      "Enjoy the last minted pixelartwork on the blockchain :-) "
      ]}
        typeSpeed={30}
        backSpeed={8}
        ></Typed>
